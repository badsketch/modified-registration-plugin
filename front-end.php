...
<div id = "fn" style="display: table-cell; padding-right: 5px; width: 500px">
<!--<div id = "fn"> -->
First Name <br>
<input type = "text" name= "firstname" id = "firstname" value="<?php echo $_POST["firstname"]; ?>"> </input>
</div>
<!-- <div id = "ln" style="position: relative; margin-top: -77px; margin-left: 300px;"> -->
<div id = "ln" style="display:table-cell; padding-left: 5px; width: 500px">
Last Name <br>
...
function modreg_registration_errors( $errors, $sanitized_user_login, $user_email ){
	...
	if($_POST['role'] != 'intl' |$_POST['role'] != 'intl'|$_POST["roleset"]!='intl')
	{
